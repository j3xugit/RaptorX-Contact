...
class ResNet4DistMatrix:
    ...
    def __init__(self, rng, seqInput, matrixInput, mask_seq=None, mask_matrix=None, embedInput=None, modelSpecs = None):
	"""
	...
	if seq2matrixMode.has_key('OuterCat') and useSequentialFeatures:
