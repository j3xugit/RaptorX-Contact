...
4) predicted solvent accessibility score represented as a L83 matrix; 5) normalized CCMpred matrix; 
6) Three other 2D matrices for pairwsie relationship generated by alnstats in MetaPSICOV. 
